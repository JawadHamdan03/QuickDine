...
import { createOwnerRestaurant, getOwnerBookings, getOwnerRestaurant, updateOwnerBookingsStatus, updateOwnerRestaurant } from '../controllers/ownerController.js';
...
ownerRouter.put("/bookings/:id/status",updateOwnerBookingsStatus);
